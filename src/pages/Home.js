...
<Navbar/>
  ...
  <main>
              ...
              <div className="col-xl-9 col-lg-9 col-md-9">
                <div className="hero__caption">
                  ...
                  <div className="hero__btn">
                    <a href="industries.html" className="btn hero-btn" data-animation="fadeInLeft" data-delay=".8s">Resurvation</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    {/* slider Area End*/}
    {/*? About Area Start */}
    <div className="about-low-area section-padding30" id='about'>
      <div className="container">
